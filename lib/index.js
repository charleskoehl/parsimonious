  ...
  _createClass(Parsimonious, null, [{
    ...
    value: function newQuery(aClass, opts) {
      ...
      if ((0, _isPlainObject2.default)(opts)) {
        ...
        include && this._toArray(include).forEach(function (str) {
          return typeof str === 'string' && q.include(str);
        });
    ...
    value: function _getJoinTableClassVars() {
      ...
      if ((0, _isPlainObject2.default)(arguments[0])) {
        var _Object$keys = Object.keys(arguments[0]); // for backwards-compatibility
        ...
        var _Object$values = Object.values(arguments[0]);

        var _Object$values2 = _slicedToArray(_Object$values, 2);

        obj1 = _Object$values2[0];
        obj2 = _Object$values2[1];
    ...
    value: function isPFObject(thing, ofClass) {
      return thing instanceof this.Parse.Object && (typeof ofClass === 'string' ? this.getPFObjectClassName(thing) === ofClass : true);
    }
    ...
    value: function getPFObjectClassName(thing) {
      var str = typeof thing === 'string' ? thing : (typeof thing === 'undefined' ? 'undefined' : _typeof(thing)) === 'object' ? thing.className : null;
