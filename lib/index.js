...
var Parsimonious = function () {
  ...
  _createClass(Parsimonious, null, [{
    key: 'init',
    value: function init(parseObject) {
      if ((typeof parseObject === 'undefined' ? 'undefined' : _typeof(parseObject)) === 'object') {
    ...
    value: function newQuery(aClass, opts) {
      var q = new this.Parse.Query(this.classStringOrSpecialClass(aClass));
