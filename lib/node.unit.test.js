...
describe('parsimonious methods', function () {
  ...
  describe('isPointer', function () {
    ...
    test('should return false for non-qualifying objects', function () {
      ...
      expect(_node4.default.isPointer({ className: 'HairBall', objectId: 'kjasoiuwne' })).toBe(false);
    ...
    test('should return true for qualifying objects', function () {
      expect(_node4.default.isPointer({ __type: 'Pointer', className: 'HairBall', objectId: 'kjasoiuwne' })).toBe(true);
      expect(_node4.default.isPointer({ objectId: 'kjasoiuwne' })).toBe(true);
      expect(_node4.default.isPointer(savedBouquets[0].toPointer())).toBe(true);
      expect(_node4.default.isPointer(TheParseObj.createWithoutData('ihsd978h293'))).toBe(true);
    });
  });
