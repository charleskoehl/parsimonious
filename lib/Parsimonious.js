...
var Parsimonious = function () {
  ...
  _createClass(Parsimonious, [{
    ...
    value: function isPointer(thing) {
      return (typeof thing === 'undefined' ? 'undefined' : _typeof(thing)) === 'object' && thing.__type === 'Pointer' && typeof thing.className === 'string' && typeof thing.objectId === 'string';
    }
  }, {
    key: 'getRole',
    ...
    value: function unJoinWithTable(classes, opts) {
      ...
      return this.getJoinQuery(classes, opts).first().then(function (joinObj) {
        if (_this2.isPFObject(joinObj)) {
          ...
          return _this2.Parse.Promise.as(undefined);
        }
      });
    }
