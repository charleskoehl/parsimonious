...
var Parsimonious = function () {
  ...
  _createClass(Parsimonious, [{
    ...
    value: function getClassInst(className, attributes, options) {
      var Cls = this.Parse.Object.extend(className);
    ...
    value: function isPointer(thing) {
      if ((typeof thing === 'undefined' ? 'undefined' : _typeof(thing)) === 'object' && thing !== null) {
        ...
        return (0, _isEqual2.default)(keys, ['__type', 'className', 'objectId']) && thing.__type === 'Pointer' && typeof thing.objectId === 'string' && typeof thing.className === 'string' || (0, _isEqual2.default)(keys, ['className', '_objCount', 'id']) && typeof thing.className === 'string' && typeof thing.id === 'string' || (0, _isEqual2.default)(keys, ['objectId']) && typeof thing.objectId === 'number';
      }
      return false;
    }
    ...
    value: function objPick(parseObj, keys) {
      ...
      if (Array.isArray(keys)) {
        return (0, _pick2.default)(this.toJsn(parseObj), keys);
      }
    }
